...
class ParaclinicosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $vacunado->prueba_antigeno = $request->input('prueba_antigeno');
        $vacunado->fecha_hora_toma_muestra_antigeno = $request->input('fecha_hora_toma_muestra_antigeno');
        $vacunado->resultado_antigeno = $request->input('resultado_antigeno');
        ...
        $vacunado->resultado_pcr = $request->input('resultado_pcr');
